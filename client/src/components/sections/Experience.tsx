...
const experiences = [
  {
    ...
    period: "2023 - Present",
    description: "Leading the frontend team in building a next-gen SaaS platform. Implemented micro-frontends architecture and improved performance by 40%."
  },
  {
    company: "Creative Pulse Studio",
    role: "Full Stack Developer",
    period: "2021 - 2023",
    description: "Developed immersive web experiences for high-profile clients. utilized Three.js and WebGL for interactive campaigns."
  },
  {
    company: "StartUp Inc.",
    role: "Junior Developer",
    period: "2019 - 2021",
    description: "Collaborated with cross-functional teams to ship features for a fintech application. Focused on React and Node.js development."
  }
];
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="md:col-span-3">
                  <h4 className="text-lg font-heading font-semibold text-secondary mb-2">{exp.role}</h4>
